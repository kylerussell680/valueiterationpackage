...
When it comes to the representation of the inputs, In my code, the states must be integers whereas the actions can be strings, integers, floats, tuples. In addition, delta is set to be arbitrarily large for the first iteration to ensure that at least two iteration occurs.
